...
def House6LordInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House6LordInHouse10Occuring(time, person))


def House6LordInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House6LordInHouse11Occuring(time, person))


def House6LordInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House6LordInHouse12Occuring(time, person))


def House7LordInHouse1Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse1Occuring(time, person))


def House7LordInHouse2Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse2Occuring(time, person))


def House7LordInHouse3Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse3Occuring(time, person))


def House7LordInHouse4Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse4Occuring(time, person))


def House7LordInHouse5Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse5Occuring(time, person))


def House7LordInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse6Occuring(time, person))


def House7LordInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse7Occuring(time, person))


def House7LordInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse8Occuring(time, person))


def House7LordInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse9Occuring(time, person))


def House7LordInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse10Occuring(time, person))


def House7LordInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse11Occuring(time, person))


def House7LordInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House7LordInHouse12Occuring(time, person))


def House8LordInHouse1Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse1Occuring(time, person))


def House8LordInHouse2Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse2Occuring(time, person))


def House8LordInHouse3Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse3Occuring(time, person))


def House8LordInHouse4Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse4Occuring(time, person))


def House8LordInHouse5Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse5Occuring(time, person))


def House8LordInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse6Occuring(time, person))


def House8LordInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse7Occuring(time, person))


def House8LordInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse8Occuring(time, person))


def House8LordInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse9Occuring(time, person))


def House8LordInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse10Occuring(time, person))


def House8LordInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse11Occuring(time, person))


def House8LordInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House8LordInHouse12Occuring(time, person))


def House9LordInHouse1Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse1Occuring(time, person))


def House9LordInHouse2Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse2Occuring(time, person))


def House9LordInHouse3Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse3Occuring(time, person))


def House9LordInHouse4Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse4Occuring(time, person))


def House9LordInHouse5Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse5Occuring(time, person))


def House9LordInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse6Occuring(time, person))


def House9LordInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse7Occuring(time, person))


def House9LordInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse8Occuring(time, person))


def House9LordInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse9Occuring(time, person))


def House9LordInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse10Occuring(time, person))


def House9LordInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse11Occuring(time, person))


def House9LordInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House9LordInHouse12Occuring(time, person))


def House10LordInHouse1Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House10LordInHouse1Occuring(time, person))


def House10LordInHouse2Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.House10LordInHouse2Occuring(time, person))


def House10LordInHouse3Occuring(time: Time, person: Person):
...
def MoonInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse6Occuring(time, person))


def MarsInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse6Occuring(time, person))


def MercuryInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse6Occuring(time, person))


def JupiterInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse6Occuring(time, person))


def VenusInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse6Occuring(time, person))


def SaturnInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse6Occuring(time, person))


def RahuInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse6Occuring(time, person))


def KetuInHouse6Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse6Occuring(time, person))


def SunInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse7Occuring(time, person))


def MoonInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse7Occuring(time, person))


def MarsInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse7Occuring(time, person))


def MercuryInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse7Occuring(time, person))


def JupiterInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse7Occuring(time, person))


def VenusInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse7Occuring(time, person))


def SaturnInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse7Occuring(time, person))


def RahuInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse7Occuring(time, person))


def KetuInHouse7Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse7Occuring(time, person))


def SunInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse8Occuring(time, person))


def MoonInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse8Occuring(time, person))


def MarsInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse8Occuring(time, person))


def MercuryInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse8Occuring(time, person))


def JupiterInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse8Occuring(time, person))


def VenusInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse8Occuring(time, person))


def SaturnInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse8Occuring(time, person))


def RahuInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse8Occuring(time, person))


def KetuInHouse8Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse8Occuring(time, person))


def SunInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse9Occuring(time, person))


def MoonInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse9Occuring(time, person))


def MarsInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse9Occuring(time, person))


def MercuryInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse9Occuring(time, person))


def JupiterInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse9Occuring(time, person))


def VenusInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse9Occuring(time, person))


def SaturnInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse9Occuring(time, person))


def RahuInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse9Occuring(time, person))


def KetuInHouse9Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse9Occuring(time, person))


def SunInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse10Occuring(time, person))


def MoonInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse10Occuring(time, person))


def MarsInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse10Occuring(time, person))


def MercuryInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse10Occuring(time, person))


def JupiterInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse10Occuring(time, person))


def VenusInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse10Occuring(time, person))


def SaturnInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse10Occuring(time, person))


def RahuInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse10Occuring(time, person))


def KetuInHouse10Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse10Occuring(time, person))


def SunInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse11Occuring(time, person))


def MoonInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse11Occuring(time, person))


def MarsInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse11Occuring(time, person))


def MercuryInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse11Occuring(time, person))


def JupiterInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse11Occuring(time, person))


def VenusInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse11Occuring(time, person))


def SaturnInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse11Occuring(time, person))


def RahuInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse11Occuring(time, person))


def KetuInHouse11Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse11Occuring(time, person))


def SunInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInHouse12Occuring(time, person))


def MoonInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInHouse12Occuring(time, person))


def MarsInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInHouse12Occuring(time, person))


def MercuryInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInHouse12Occuring(time, person))


def JupiterInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInHouse12Occuring(time, person))


def VenusInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInHouse12Occuring(time, person))


def SaturnInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInHouse12Occuring(time, person))


def RahuInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.RahuInHouse12Occuring(time, person))


def KetuInHouse12Occuring(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.KetuInHouse12Occuring(time, person))


def Lord2WithEvilInHouse(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2WithEvilInHouse(time, person))


def SaturnIn2WithVenus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnIn2WithVenus(time, person))


def MoonMarsIn2WithSaturnAspect(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonMarsIn2WithSaturnAspect(time, person))


def MercuryAndEvilIn2WithMoonAspect(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryAndEvilIn2WithMoonAspect(time, person))


def SunIn2WithNoSaturnAspect(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunIn2WithNoSaturnAspect(time, person))


def MoonIn2WithMercuryAspect(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonIn2WithMercuryAspect(time, person))


def Lord2And3In6WithEvilPlanet(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2And3In6WithEvilPlanet(time, person))


def Lord2InHouse1(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse1(time, person))


def Lord2InHouse1AndLord1InHouse2(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse1AndLord1InHouse2(time, person))


def Lord2InHouse3(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse3(time, person))


def Lord2InHouse4(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse4(time, person))


def Lord2InHouse5(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse5(time, person))


def Lord2InHouse6(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse6(time, person))


def Lord2InHouse7(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse7(time, person))


def Lord2InHouse8(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse8(time, person))


def Lord2InHouse9(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse9(time, person))


def Lord2InHouse10(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse10(time, person))


def Lord2InHouse11(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse11(time, person))


def Lord2InHouse12(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord2InHouse12(time, person))


def MaleficIn11FromArudha(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MaleficIn11FromArudha(time, person))


def BeneficIn11FromArudha(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.BeneficIn11FromArudha(time, person))


def SunInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInAries(time, person))


def SunInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInTaurus(time, person))


def SunInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInGemini(time, person))


def SunInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInCancer(time, person))


def SunInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInLeo(time, person))


def SunInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInVirgo(time, person))


def SunInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInLibra(time, person))


def SunInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInScorpio(time, person))


def SunInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInSagittarius(time, person))


def SunInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInCapricornus(time, person))


def SunInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInAquarius(time, person))


def SunInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunInPisces(time, person))


def MoonInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInAries(time, person))


def MoonInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInTaurus(time, person))


def MoonInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInGemini(time, person))


def MoonInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInCancer(time, person))


def MoonInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInLeo(time, person))


def MoonInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInVirgo(time, person))


def MoonInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInLibra(time, person))


def MoonInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInScorpio(time, person))


def MoonInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInSagittarius(time, person))


def MoonInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInCapricornus(time, person))


def MoonInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInAquarius(time, person))


def MoonInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MoonInPisces(time, person))


def MarsInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInAries(time, person))


def MarsInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInTaurus(time, person))


def MarsInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInGemini(time, person))


def MarsInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInCancer(time, person))


def MarsInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInLeo(time, person))


def MarsInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInVirgo(time, person))


def MarsInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInLibra(time, person))


def MarsInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInScorpio(time, person))


def MarsInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInSagittarius(time, person))


def MarsInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInCapricornus(time, person))


def MarsInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInAquarius(time, person))


def MarsInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsInPisces(time, person))


def MercuryInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInAries(time, person))


def MercuryInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInTaurus(time, person))


def MercuryInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInGemini(time, person))


def MercuryInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInCancer(time, person))


def MercuryInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInLeo(time, person))


def MercuryInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInVirgo(time, person))


def MercuryInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInLibra(time, person))


def MercuryInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInScorpio(time, person))


def MercuryInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInSagittarius(time, person))


def MercuryInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInCapricornus(time, person))


def MercuryInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInAquarius(time, person))


def MercuryInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryInPisces(time, person))


def JupiterInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInAries(time, person))


def JupiterInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInTaurus(time, person))


def JupiterInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInGemini(time, person))


def JupiterInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInCancer(time, person))


def JupiterInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInLeo(time, person))


def JupiterInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInVirgo(time, person))


def JupiterInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInLibra(time, person))


def JupiterInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInScorpio(time, person))


def JupiterInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInSagittarius(time, person))


def JupiterInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInCapricornus(time, person))


def JupiterInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInAquarius(time, person))


def JupiterInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.JupiterInPisces(time, person))


def VenusInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInAries(time, person))


def VenusInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInTaurus(time, person))


def VenusInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInGemini(time, person))


def VenusInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInCancer(time, person))


def VenusInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInLeo(time, person))


def VenusInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInVirgo(time, person))


def VenusInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInLibra(time, person))


def VenusInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInScorpio(time, person))


def VenusInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInSagittarius(time, person))


def VenusInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInCapricornus(time, person))


def VenusInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInAquarius(time, person))


def VenusInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.VenusInPisces(time, person))


def SaturnInAries(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInAries(time, person))


def SaturnInTaurus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInTaurus(time, person))


def SaturnInGemini(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInGemini(time, person))


def SaturnInCancer(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInCancer(time, person))


def SaturnInLeo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInLeo(time, person))


def SaturnInVirgo(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInVirgo(time, person))


def SaturnInLibra(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInLibra(time, person))


def SaturnInScorpio(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInScorpio(time, person))


def SaturnInSagittarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInSagittarius(time, person))


def SaturnInCapricornus(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInCapricornus(time, person))


def SaturnInAquarius(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInAquarius(time, person))


def SaturnInPisces(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnInPisces(time, person))


def MarsVenusIn7th(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsVenusIn7th(time, person))


def MercuryOrJupiterIn7th(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MercuryOrJupiterIn7th(time, person))


def LeoLagna7thLordSaturnIn2(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.LeoLagna7thLordSaturnIn2(time, person))


def SaturnIn7thNotLagnaLord(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnIn7thNotLagnaLord(time, person))


def MarsIn7thNoBenefics(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.MarsIn7thNoBenefics(time, person))


def SunVenusIn5th7th9th(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SunVenusIn5th7th9th(time, person))


def Lord7And1Friends(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord7And1Friends(time, person))


def Lord7And1NotFriends(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.Lord7And1NotFriends(time, person))


def SaturnIn7th(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.SaturnIn7th(time, person))


def LordInTrine(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.LordInTrine(time, person))


def GeminiRisingWithEvilPlanet(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.GeminiRisingWithEvilPlanet(time, person))


def AriesRisingWithEvilPlanet(time: Time, person: Person):
    return CalculatorResult(libray.HoroscopeCalculatorMethods.AriesRisingWithEvilPlanet(time, person))
