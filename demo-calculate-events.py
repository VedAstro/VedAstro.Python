...
tagList = List[libray.EventTag]()
tagList.Add(libray.EventTag.General)
tagList.Add(libray.EventTag.Medical)
...
precisionInHours = 1;
event_list = libray.EventManager.CalculateEvents(precisionInHours, start_time, end_time, geolocation,john_doe,tagList).GetAwaiter().GetResult()
